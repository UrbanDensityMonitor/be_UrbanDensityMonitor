"""
Global configuration for Traffic State Discovery (VERSI RISET).
Dipindah dari app/services/core_ml/config.py — runtime API hanya memakai
TrackingConfig & FeatureExtractionConfig yang tetap di app/services/core_ml/config.py
"""
